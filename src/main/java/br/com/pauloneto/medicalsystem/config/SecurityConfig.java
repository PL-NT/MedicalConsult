...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("Paulo").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("Andressa").password(passwordEncoder.encode("95989")).roles("PACIENTE")
                .and()
                .withUser("Edgar").password(passwordEncoder.encode("141414")).roles("SECRETARIO");
